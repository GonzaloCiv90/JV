                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <div class="ms-lg-auto d-flex align-items-center">
                            ...
                            <a href="mailto:jvrefrigeracion58@gmail.com?subject=Consulta%20sobre%20sus%20servicios&body=Hola%2C%20quisiera%20hacer%20una%20consulta%20sobre%20sus%20servicios." target="_blank" class="text-white me-3"><i class="bi bi-envelope-at-fill"></i></a>
                        </div>
        ...
        <section id="carousel-section">
            ...
            <div class="overlay">
                <section class="text-white d-flex flex-column justify-content-center align-items-center h-100 ps-2">
                    <h1>Servicios de climatización profesional de aires acondicionados y cámaras frigoríficas.</h1>
                    <br>
                    <h2>Aires acondicionados industriales, comerciales y para el hogar.</h2>
                    <div class="mt-3">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <p>¿Quiénes Somos?</p>
                        <p>Somos una empresa dedicada a brindar soluciones innovadoras en el sector de la climatización.
                            Nuestro equipo está formado por profesionales expertos en el mantenimiento, diagnóstico, reparación e instalación de sistemas de aire acondicionado,
                            tanto para la industria como para el hogar.
                            Nuestro compromiso es ofrecer un servicio de calidad, adaptado a las necesidades de cada cliente.</p>
